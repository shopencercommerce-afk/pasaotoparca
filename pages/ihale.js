  ...
  return <main className="page">
    ...
    {formOpen ? <Modal title="Yeni Araç" onClose={() => setFormOpen(false)}>
      <form className="modalForm" onSubmit={saveCar}>
        ...
        <input value={form.purchasePrice} onChange={e => setForm({ ...form, purchasePrice: moneyText(e.target.value) })} placeholder="Araç bedeli" />
