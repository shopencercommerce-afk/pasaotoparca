  ...
  return (
    <main className="page">
      ...
      <section className="intro">
        ...
        <h1>{pageTitle}</h1>
        <p>Bu filtrede {filteredProducts.length} ürün var. İlk {visibleProducts.length} ürün gösteriliyor. Ürünü sepete ekleyebilir veya WhatsApp ile direkt teklif alabilirsiniz.</p>
