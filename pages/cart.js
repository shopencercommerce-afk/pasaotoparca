  ...
  return (
    <main className="page">
      <header className="header">
        <a href="/" className="brand"><img src="/logo-new.svg" alt="Paşa Oto Parça" /></a>
