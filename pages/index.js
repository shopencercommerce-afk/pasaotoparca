    ...
    <main className="page">
      ...
      <header className="header">
        ...
        <div className="searchBox">
          <span>Ürün adı, parça kodu veya araç modeli ara</span>
          <strong>⌕</strong>
        </div>
      ...
      <section className="hero">
        ...
        <div className="heroPanel">
          <div className="panelHeader">
            ...
            <strong>EV Parts</strong>
          </div>
          <div className="brandTiles">
            {popularBrands.map(brand => (
              <a href={productsUrl(brand.slug)} key={brand.slug}>{brand.name}</a>
            ))}
          </div>
      ...
      <section className="section">
        <div className="sectionHead">
          <div>
            <span>MARKA SEÇİMİ</span>
            <h2>Aracınıza uygun parçaları bulun</h2>
          </div>
            ...
            return (
              <article className="productCard" key={`${product.no || product.id}-${productCode(product)}`}>
                ...
                <div className="productInfo">
                  ...
                  <a href={wpUrl} className="quoteBtn">Teklif Al</a>
                </div>
              </article>
            )
          })}
      ...
      <section className="ctaBand">
        <div>
          <span>PARÇA KODUNUZ VAR MI?</span>
          <h2>Doğru parçayı birlikte teyit edelim.</h2>
          <p>Parça kodu, araç modeli veya şase bilginizi WhatsApp’tan gönderin. Size uygun ürünü hızlıca netleştirelim.</p>
        </div>
