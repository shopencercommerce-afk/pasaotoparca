      ...
      <section className="detail">
        ...
        <div className="infoCard">
          ...
          <div className="actions">
            ...
            <button className="secondary" type="button">Sepete Ekle</button>
          </div>
        </div>
      </section>
